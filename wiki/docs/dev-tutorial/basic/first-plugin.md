...
本教程创建一个最小的 Harness 插件，并将其加载到 Web UI 中。请从已完成[从源码运行路径](https://github.com/deepseek-ai/deepseek-harness/blob/master/README.md#run-from-source)的仓库检出开始。
...
- [Cordis 框架教程](../cordis-tutorial/index.md) — 底层插件框架，在临时目录中动手构建，无需 API 密钥
